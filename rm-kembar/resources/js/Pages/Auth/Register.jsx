            ...
            <section className="mx-auto max-w-md px-4 py-12">
                ...
                <form className="mt-6 space-y-4 rounded-md border border-zinc-200 bg-white p-5" onSubmit={submit}>
                    ...
                    <label className="block text-sm font-medium">Konfirmasi Password
                        <input className="mt-1 w-full rounded-md border border-zinc-300 px-3 py-2" type="password" value={data.password_confirmation} onChange={(e) => setData('password_confirmation', e.target.value)} required />
                    </label>
